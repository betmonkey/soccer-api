    ...
    for fixture in fixtures:
        ...
        try:
            ...
            if stats["home_team"]["clean_sheet_home_perc"] < 0.5 and stats["away_team"]["clean_sheet_away_perc"] < 0.5:
                ...
                if stats["home_team"]["failed_to_score_home_perc"] < 0.5 and stats["away_team"]["failed_to_score_away_perc"] < 0.5:
                    # Goals for and away must be great than 2.5 for home team
                   if stats["home_team"]["average_goals_for_home"] + stats["home_team"]["average_goals_against_home"] > 2.5:
                       # Goals for and away must be great than 2.5 for away team
                       if stats["away_team"]["average_goals_for_away"] + stats["away_team"]["average_goals_against_away"] > 2.5:
                            betting_list.append(fixture)
